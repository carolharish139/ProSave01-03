...
import Admin from './pages/Admin';  // דף מנהל
    ...
    <Router>
      <div className="app">
        ...
        <Routes>
          <Route
            path="/"
            element={isLoggedIn ? <Navigate to="/home" /> : <Login setIsLoggedIn={setIsLoggedIn} setRole={setRole} />}
          />
          ...
          <Route path="/admin" element={role === 'admin' ? <Admin /> : <Navigate to="/home" />} />
        </Routes>
        <Footer />
      </div>
    </Router>
